    ...
    <el-form :model="value" ref="productSaleForm" label-width="120px" style="width: 600px" size="small">
      ...
      <el-form-item label="服務保證：">
        <el-checkbox-group v-model="selectServiceList">
          <el-checkbox :label="1">無憂退貨</el-checkbox>
          <el-checkbox :label="2">快速退款</el-checkbox>
          <el-checkbox :label="3">免費包郵</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
      ...
      <el-form-item label="選擇優惠方式：">
        <el-radio-group v-model="value.promotionType" size="small">
          ...
          <el-radio-button :label="3">階梯價格</el-radio-button>
          <el-radio-button :label="4">滿減價格</el-radio-button>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">上一步，填寫商品信息</el-button>
        <el-button type="primary" size="medium" @click="handleNext">下一步，填寫商品屬性</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
