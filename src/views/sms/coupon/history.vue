<template> 
  <div class="app-container">
    <div class="table-layout">
      <el-row>
        <el-col :span="4" class="table-cell-title">名稱</el-col>
        <el-col :span="4" class="table-cell-title">優惠券類型</el-col>
        <el-col :span="4" class="table-cell-title">可使用商品</el-col>
        <el-col :span="4" class="table-cell-title">使用門檻</el-col>
        <el-col :span="4" class="table-cell-title">面值</el-col>
        <el-col :span="4" class="table-cell-title">狀態</el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="4" class="table-cell">滿{{coupon.minPoint}}元可用</el-col>
      ...
      <el-row>
        ...
        <el-col :span="4" class="table-cell-title">總發行量</el-col>
        <el-col :span="4" class="table-cell-title">已領取</el-col>
        <el-col :span="4" class="table-cell-title">待領取</el-col>
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="訂單編號：">
            <el-input v-model="listQuery.orderSn" class="input-width" placeholder="訂單編號"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    <div class="table-container">
      <el-table ref="couponHistoryTable"
        ...
        <el-table-column label="優惠碼" width="160" align="center">
          <template slot-scope="scope">{{scope.row.couponCode}}</template>
        </el-table-column>
        <el-table-column label="領取會員" width="140" align="center">
          <template slot-scope="scope">{{scope.row.memberNickname}}</template>
        </el-table-column>
        <el-table-column label="領取方式" width="100" align="center">
          <template slot-scope="scope">{{scope.row.getType | formatGetType}}</template>
        </el-table-column>
        <el-table-column label="領取時間" width="160" align="center">
          <template slot-scope="scope">{{scope.row.createTime | formatTime}}</template>
        </el-table-column>
        <el-table-column label="當前狀態" width="140" align="center">
          <template slot-scope="scope">{{scope.row.useStatus | formatCouponHistoryUseType}}</template>
        </el-table-column>
        <el-table-column label="使用時間" width="160" align="center">
