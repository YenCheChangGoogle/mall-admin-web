  ...
  <div class="detail-container">
    <div>
      <el-steps :active="formatStepStatus(order.status)" finish-status="success" align-center>
        ...
        <el-step title="支付訂單" :description="formatTime(order.paymentTime)"></el-step>
        <el-step title="平台發貨" :description="formatTime(order.deliveryTime)"></el-step>
        <el-step title="確認收貨" :description="formatTime(order.receiveTime)"></el-step>
        <el-step title="完成評價" :description="formatTime(order.commentTime)"></el-step>
      </el-steps>
    </div>
    <el-card shadow="never" style="margin-top: 15px">
      <div class="operate-container">
        <i class="el-icon-warning color-danger" style="margin-left: 20px"></i>
        <span class="color-danger">當前訂單狀態：{{order.status | formatStatus}}</span>
        <div class="operate-button-container" v-show="order.status===0">
          <el-button size="mini" @click="showUpdateReceiverDialog">修改收貨人信息</el-button>
          <el-button size="mini">修改商品信息</el-button>
          <el-button size="mini" @click="showUpdateMoneyDialog">修改費用信息</el-button>
          <el-button size="mini" @click="showMessageDialog">發送站內信</el-button>
          <el-button size="mini" @click="showCloseOrderDialog">關閉訂單</el-button>
          <el-button size="mini" @click="showMarkOrderDialog">備註訂單</el-button>
        </div>
        <div class="operate-button-container" v-show="order.status===1">
          <el-button size="mini" @click="showUpdateReceiverDialog">修改收貨人信息</el-button>
          <el-button size="mini" @click="showMessageDialog">發送站內信</el-button>
          <el-button size="mini">取消訂單</el-button>
          <el-button size="mini" @click="showMarkOrderDialog">備註訂單</el-button>
        </div>
        <div class="operate-button-container" v-show="order.status===2||order.status===3">
          <el-button size="mini" @click="showLogisticsDialog">訂單跟蹤</el-button>
          <el-button size="mini" @click="showMessageDialog">發送站內信</el-button>
          <el-button size="mini" @click="showMarkOrderDialog">備註訂單</el-button>
        </div>
        <div class="operate-button-container" v-show="order.status===4">
          <el-button size="mini" @click="handleDeleteOrder">刪除訂單</el-button>
          <el-button size="mini" @click="showMarkOrderDialog">備註訂單</el-button>
        </div>
      </div>
      ...
      <div class="table-layout">
        <el-row>
          <el-col :span="4" class="table-cell-title">訂單編號</el-col>
          <el-col :span="4" class="table-cell-title">發貨單流水號</el-col>
          <el-col :span="4" class="table-cell-title">用戶賬號</el-col>
          <el-col :span="4" class="table-cell-title">支付方式</el-col>
          <el-col :span="4" class="table-cell-title">訂單來源</el-col>
          <el-col :span="4" class="table-cell-title">訂單類型</el-col>
        </el-row>
        <el-row>
          <el-col :span="4" class="table-cell">{{order.orderSn}}</el-col>
          <el-col :span="4" class="table-cell">暫無</el-col>
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">物流單號</el-col>
          <el-col :span="4" class="table-cell-title">自動確認收貨時間</el-col>
          <el-col :span="4" class="table-cell-title">訂單可得優幣</el-col>
          <el-col :span="4" class="table-cell-title">訂單可得成長值</el-col>
          <el-col :span="4" class="table-cell-title">活動信息</el-col>
        </el-row>
        <el-row>
      ...
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">收貨人信息</span>
      </div>
      <div class="table-layout">
        <el-row>
          <el-col :span="6" class="table-cell-title">收貨人</el-col>
          <el-col :span="6" class="table-cell-title">手機號碼</el-col>
          <el-col :span="6" class="table-cell-title">郵政編碼</el-col>
          <el-col :span="6" class="table-cell-title">收貨地址</el-col>
        </el-row>
        <el-row>
      ...
      <el-table
        ...
        <el-table-column label="價格/貨號" width="120" align="center">
          <template slot-scope="scope">
            <p>價格：￥{{scope.row.productPrice}}</p>
            <p>貨號：{{scope.row.productSn}}</p>
          </template>
        </el-table-column>
      ...
      <div style="float: right;margin: 20px">
        合計：<span class="color-danger">￥{{order.totalAmount}}</span>
      </div>
      <div style="margin-top: 60px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">費用信息</span>
      </div>
      <div class="table-layout">
        <el-row>
          <el-col :span="6" class="table-cell-title">商品合計</el-col>
          <el-col :span="6" class="table-cell-title">運費</el-col>
          <el-col :span="6" class="table-cell-title">優惠券</el-col>
          <el-col :span="6" class="table-cell-title">積分抵扣</el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="6" class="table-cell-title">活動優惠</el-col>
          <el-col :span="6" class="table-cell-title">折扣金額</el-col>
          <el-col :span="6" class="table-cell-title">訂單總金額</el-col>
          <el-col :span="6" class="table-cell-title">應付款金額</el-col>
        </el-row>
        <el-row>
      ...
      <el-table style="margin-top: 20px;width: 100%"
        ...
        <el-table-column label="操作時間"  width="160" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="發貨狀態"  width="120" align="center">
          <template slot-scope="scope">
    ...
    <el-dialog title="修改收貨人信息"
      ...
      <el-button type="primary" @click="handleUpdateReceiverInfo">確 定</el-button>
      </span>
    </el-dialog>
    <el-dialog title="修改費用信息"
      ...
      <el-button type="primary" @click="handleUpdateMoneyInfo">確 定</el-button>
      </span>
    </el-dialog>
    <el-dialog title="發送站內信"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleSendMessage">確 定</el-button>
      </span>
    </el-dialog>
    <el-dialog title="關閉訂單"
               :visible.sync="closeDialogVisible"
               width="40%">
      <el-form :model="closeInfo"
               label-width="150px">
        <el-form-item label="操作備註：">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleCloseOrder">確 定</el-button>
      </span>
    </el-dialog>
    <el-dialog title="備註訂單"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleMarkOrder">確 定</el-button>
      </span>
    </el-dialog>
